...
module.exports = client => {
  ...
  //online = çevrimiçi
  console.log(`                                                                                                                                                                     `)
  client.user.setActivity(`Kartalya BOT | ${client.guilds.size} sunucu | ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcıyı hizmet veriyor.`, { type: "WATCHING"});
  //LISTENING = DİNLİYOR
  //WATCHING = İZLİYOR
  //PLAYING = OYNUYOR 
